...
#recorriendo la conjunto numeros y multiplicando cada vallr por 10
...
#recorremos dos conjuntos al mismo tiempo con zip
...
#forma correcta de recorrer una conjunto con su 
